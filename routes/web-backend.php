...
use App\Http\Controllers\course\backend\CategoryController as CourseCategoryController;
...
use App\Http\Controllers\course_registration\backend\CourseRegistrationController;
...
Route::group(['middleware' => 'locale'], function () {
    Route::group(['prefix' => env('APP_ADMIN'), 'middleware' => ['auth:web']], function () {
        ...
        Route::group(['prefix' => '/generals'], function () {
            ...
            Route::group(['prefix' => '/ajax'], function () {
                Route::get('/tom-select', [GeneralController::class, 'system_select2'])->name('generals.system.select2');
                Route::get('/tom-select-data', [GeneralController::class, 'render_select2'])->name('generals.system.render_select2');
            });
        });
        ...
        Route::group(['prefix' => '/category-articles'], function () {
            ...
            Route::post('/update-view', [BackendCategoryController::class, 'update_view'])->name('category_articles.update_view')->middleware('can:category_articles_edit');
        });
        //danh sách article
        ...
        Route::group(['prefix' => '/course-registrations'], function () {
            Route::get('/index', [CourseRegistrationController::class, 'index'])->name('course_registrations.index')->middleware('can:course_registrations_index');
            Route::get('/create', [CourseRegistrationController::class, 'create'])->name('course_registrations.create')->middleware('can:course_registrations_create');
            Route::post('/store', [CourseRegistrationController::class, 'store'])->name('course_registrations.store');
            Route::get('/edit/{id}', [CourseRegistrationController::class, 'edit'])->name('course_registrations.edit')->middleware('can:course_registrations_edit');
            Route::post('/update/{id}', [CourseRegistrationController::class, 'update'])->name('course_registrations.update')->middleware('can:course_registrations_edit');
            Route::get('/destroy/{id}', [CourseRegistrationController::class, 'destroy'])->name('course_registrations.destroy')->middleware('can:course_registrations_destroy');
            Route::get('/search-customer', [CourseRegistrationController::class, 'ajaxSearchCustomer'])->name('course_registrations.search_customer');
            Route::get('/search-course', [CourseRegistrationController::class, 'ajaxSearchCourse'])->name('course_registrations.search_course');
        });

        //danh mục cource
        Route::group(['prefix' => '/category-courses'], function () {
            Route::get('/index', [CourseCategoryController::class, 'index'])->name('category_courses.index')->middleware('can:category_courses_index');
            Route::get('/create', [CourseCategoryController::class, 'create'])->name('category_courses.create')->middleware('can:category_courses_create');
            Route::post('/store', [CourseCategoryController::class, 'store'])->name('category_courses.store')->middleware('can:category_courses_create');
            Route::get('/edit/{id}', [CourseCategoryController::class, 'edit'])->name('category_courses.edit')->middleware('can:category_courses_edit');
            Route::post('/update/{id}', [CourseCategoryController::class, 'update'])->name('category_courses.update')->middleware('can:category_courses_edit');
            Route::get('/destroy/{id}', [CourseCategoryController::class, 'destroy'])->name('category_courses.destroy')->middleware('can:category_courses_destroy');
        });
        //danh sách cource
        Route::group(['prefix' => '/courses'], function () {
            ...
            Route::get('/destroy/{id}', [CourseController::class, 'destroy'])->name('courses.destroy')->middleware('can:courses_destroy');
            Route::post('/select2', [CourseController::class, 'select2']);
            Route::post('/delete-image', [CourseController::class, 'delete_image'])->name('course.delete_image');
            Route::post('/add-image', [CourseController::class, 'add_image'])->name('course.add_image');
        });
        ...
        Route::group(['prefix' => '/book'], function () {
            Route::get('/index', [ContactController::class, 'expert'])->name('contacts.expert')->middleware('can:contacts_index');
        });

...
if (!function_exists('htmlItemCart')) {
    function htmlItemCart($k = '', $item = [])
    {
        ...
        if (isset($item)) {
            ...
            $slug = (config('app.locale') != 'vi') ? config('app.locale').'/'.$slug : $slug;
                        ...
                        <td class="p-3 border border-solid  text-center ">
                            <div class="flex items-center space-x-2 justify-center">
                             <div class="flex count border border-solid border-gray-300 p-2 h-11">
                                ...
                                <input type="number" min="1" max="' . $stock . '" step="1" value="' . $item['quantity'] . '" class="tp_cardQuantity border-0 p-0 flex-auto w-8 text-center focus:outline-none input-appearance-none card-quantity">

...
use App\Policies\CategoryCoursePolicy;
...
use App\Policies\CourseRegistrationsPolicy;
...
class AuthServiceProvider extends ServiceProvider
{
    ...
    {
        Gate::define('course_registrations_index', [CourseRegistrationsPolicy::class, 'index']);
        Gate::define('course_registrations_create', [CourseRegistrationsPolicy::class, 'create']);
        Gate::define('course_registrations_edit', [CourseRegistrationsPolicy::class, 'edit']);
        Gate::define('course_registrations_destroy', [CourseRegistrationsPolicy::class, 'destroy']);
    }
    ...
    public function gateCourseCategory()
    {
        Gate::define('category_courses_index', [CategoryCoursePolicy::class, 'index']);
        Gate::define('category_courses_create', [CategoryCoursePolicy::class, 'create']);
        Gate::define('category_courses_edit', [CategoryCoursePolicy::class, 'edit']);
        Gate::define('category_courses_destroy', [CategoryCoursePolicy::class, 'destroy']);
    }
    public function gateCourse()
    {

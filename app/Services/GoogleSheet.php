...

{
...

    {
        ...
        $this->spreadSheetId = config('sheets.google_sheet_id');
...

    {
        ...
        $range = 'Demo!A2:' . $dimensions['colCount'];
...

    {
        ...
        $rowDimensions = $this->googleSheetService->spreadsheets_values->batchGet(
            ...
            ['ranges' => 'Demo!A:A', 'majorDimension' => 'COLUMNS']
        ...
        $colDimensions = $this->googleSheetService->spreadsheets_values->batchGet(
            ...
            ['ranges' => 'Demo!1:1', 'majorDimension' => 'ROWS']

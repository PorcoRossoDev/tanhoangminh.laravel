...
class ArticleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data =  $data->select('articles.id', 'articles.image', 'articles.title', 'articles.slug', 'articles.catalogue_id', 'articles.userid_created', 'articles.created_at', 'articles.publish', 'articles.order', 'articles.ishome', 'articles.highlight', 'articles.isaside', 'articles.isfooter', 'articles.isagency');

...
class CategoryController extends Controller
{
    ...
    public function index(Request $request, $slug = "", $id = 0)
    {
        ...
        $data =  Product::join('catalogues_relationships', 'products.id', '=', 'catalogues_relationships.moduleid')
            ...
            ->select('category_products.title as titleC', 'category_products.slug as slugC', 'products.id', 'products.description', 'products.title', 'products.type_attr', 'products.slug', 'products.image', 'products.price', 'products.price_sale', 'products.code', 'products.price_contact', 'products.image_json');
        if (!empty($detail->id)) {
        ...
        return view($view, compact('fcSystem', 'module', 'detail', 'seo', 'data', 'breadcrumb', 'attributes', 'brandFilter'));
    }
    //Page: Sản phẩm

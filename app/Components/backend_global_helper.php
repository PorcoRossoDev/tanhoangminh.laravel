...
if (!function_exists('activeMenu')) {
    function activeMenu($uri = '')
    {
        ...
        $active = '';
        if (Request::is(Request::segment(1) . '/' . $uri . '/*') || Request::is(Request::segment(1) . '/' . $uri) || Request::is($uri) || Request::is(Request::segment(1) . '/' . $url . '/*')) {
...
if (!function_exists('getOptionTomSelect')) {
    function getOptionTomSelect($module = '', $ids = [])
    {
        $data = DB::table($module)->whereIn('id', $ids)->get();

...
class Course_relationships extends Model
{
    use HasFactory;
    ...
    {
        return $this->hasMany(Comment::class, 'module_id', 'id')->where('module', '=', 'courses')->where('parentid', 0);
    }
    public function tagsArticle()
    {
        return $this->hasMany(Tags_relationship::class, 'module_id', 'id')->where('tags_relationships.module', '=', 'courses')->join('tags', 'tags.id', '=', 'tags_relationships.tag_id');
    }
    ...
    {
        return $this->belongsTo(Course::class, 'moduleid', 'id');
    }
    
    public function videos()
    {
        return $this->hasMany(CourseVideo::class, 'course_id', 'moduleid');
    }
}

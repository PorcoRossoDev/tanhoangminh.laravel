        ...
        <div class=" col-span-12 lg:col-span-8">
            <ul class="nav nav-link-tabs flex-wrap" role="tablist">
                ...
                <li id="example-course-tab" class="nav-item " role="presentation">
                    <button class="nav-link w-full py-2 " data-tw-toggle="pill" data-tw-target="#example-tab-course" type="button" role="tab" aria-controls="example-tab-course" aria-selected="true">Thông tin khóa học</button>
                </li>
                @if(!$field->isEmpty())
            ...
            <div class=" box p-5">
                ...
                <div class="tab-content">
                    <div id="example-tab-homepage" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="example-homepage-tab">
                        ...
                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Chi tiết khóa học</label>
                            <div class="mt-2">
                    ...
                    <div id="example-tab-course" class="tab-pane leading-relaxed" role="tabpanel" aria-labelledby="example-course-tab">
                        @include('course.backend.course.common.data_course', ['module' => $module])
                    </div>
                </div>
            ...
            <div class=" box p-5 mt-3 space-y-3">
                <div>
                    @include('course.backend.course.common.album')

        ...
        <div class="container">
            <div class="xl:flex xl:flex-row gap-[25px] wow fadeInLeft">
                    ...
                    @if($noibat && $noibat->isNotEmpty())
                        @foreach($noibat as $cat)
                            <div>
                                ...
                                <div class="4xl:mt-[50px] 3xl:mt-[30px] h-[485px] overflow-y-scroll overflow-hidden scroll-bds">
                ...
                <div class="4xl:w-[890px] 3xl:w-[700px] 2xl:w-[640px] xl:mt-0 mt-5 w-full wow fadeInTop">
                    <h1 class="font-extrabold 4xl:text-[60px] 3xl:text-[45px] text-[50px] text-f40px text-color_primary text-center">THM 360</h1>
                            ...
                            @if( $comment && $comment->slides->isNotEmpty() )
                                @foreach( $comment->slides as $slide )
                                    <div class="flex bg-[#EAEAE5] mt-[22px] py-[24px] px-[15px] rounded-[30px] th360-comment">
                                        ...
                                        <div class="ml-[25px]">
                                            <h4 class="font-bold 4xl:text-f25 3xl:text-f21 text-f20" style="
                                            overflow: hidden;
                                            text-overflow: ellipsis;
                                            -webkit-box-orient: vertical;
                                            -webkit-line-clamp: 1;
                ...
                <div class="4xl:w-[1200px] 3xl:w-[900px] xl:w-[600px] w-full">
                    @if($th_zoom && $th_zoom->isNotEmpty())
                        @foreach($th_zoom as $cat)
                            <h3 class="font-bold 2xl:text-[40px] xl:text-[35px] text-f30 uppercase">{{ $cat->title }}</h3>
                            <div class="grid grid-cols-2 gap-[12px] mt-[40px]">
                                ...
                                <div class="relative rounded-[30px] overflow-hidden wow fadeInUp" data-wow-delay="0.2s">
                                    ...
                                    <div class="absolute bottom-[30px] z-10 w-full text-white px-[24px]">
                                        ...
                                        <h4 class="2xl:text-f24 xl:text-f20 text-f19 font-semibold" style="
                                            overflow: hidden;
                                            text-overflow: ellipsis;
                                            -webkit-box-orient: vertical;
                                            -webkit-line-clamp: 2;
            ...
            <section class="mt-[85px]">
                <div class="container">
                    ...
                    <div class="xl:flex mt-[40px] gap-[30px]">
                        ...
                        <div class="xl:flex-1 w-full xl:mt-0 mt-6 tabBlock">
                            <ul class="tabBlock-tabs xl:text-left text-center 2xl:text-f18 xl:text-f16">
                                <li class="inline-block"><a href="javascript:void(0)" data-tab="data-file-1" class="tabBlock-tab border border-color_primary bg-color_primary text-white rounded-[115px] 2xl:mr-[20px] mr-[15px] 2xl:py-[8px] py-[3px] px-[14px] inline-block hover:bg-color_primary hover:text-white hover:border-color_primary duration-300">Tài liệu mới</a></li>
                                <li class="inline-block"><a href="javascript:void(0)" data-tab="data-file-2" class="tabBlock-tab border rounded-[115px] 2xl:mr-[20px] mr-[15px] 2xl:py-[8px] py-[3px] px-[14px] inline-block hover:bg-color_primary hover:text-white hover:border-color_primary duration-300">Tài liệu xem nhiều</a></li>
                            </ul>
                ...
                <div class="container">
                    ...
                    <div class="xl:flex mt-[40px] gap-[30px]">
                        <div class="4xl:w-[590px] 3xl:w-[470px] w-full h-[630px] overflow-y-scroll scroll-bds">
                            @foreach( $cat->posts as $k => $post )
                            <div class="flex gap-[30px] h-[200px] mb-[33px]">
                                <div class="4xl:w-[245px] 3xl:w-[200px] w-[215px]">
                                    <img src="{{asset($post->image)}}" class="w-full h-full object-cover rounded-[20px]" alt="">
                                </div>
                                <div class="flex-1">
                                    <div>
                                    ...
                                    <div class="mt-[22px]">
                                        <h3 class="font-bold 4xl:text-f22 text-f19"><a href="{{route('routerURL', ['slug' => $post->slug])}}">{{$post->title}}</a></h3>
                                    </div>
                                </div>
                            </div>
                            @endforeach

                        ...
                        <ul class="folder-list" id="folder-list" style="padding: 0">
                            ...
                            <li class="mt-2">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div>
                                        <a type="button" class="slide-group-edit text-danger mr-2" href="javascript:void(0)" data-id="{{$v->id}}" data-title="{{$v->title}}" data-tw-toggle="modal" data-tw-target="#basic-modal-edit-group" data-json="{{ base64_encode($v) }}"> Sửa</a>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content animated fadeIn">
            ...
            <div class="modal-body">
                ...
                <form class="m-t slide-group" role="form" method="post" action="{{route('slides.category_update')}}" id="editCategorySlide">
                    <div class="form-group">
                        <label class="form-label text-base font-semibold">Tên nhóm Slide</label>
                        <input type="text" placeholder="" name="title" class="title form-control">
                        <input type="hidden" placeholder="" name="id" class="id">
                    </div>
                    <div class="form-group mt-4">
                        <label class="form-label text-base font-semibold">Đường dẫn</label>
                        <input type="text" placeholder="" name="slug" class="form-control slug">
                    </div>
                    <div class="form-group mt-4">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content animated fadeIn">
            ...
            <div class="modal-body">
                ...
                <form class="m-t slide-group" role="form" method="post" action="" id="addCategorySlide">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                ...
                <form class="m-t update-group" role="form" method="post" action="" id="">

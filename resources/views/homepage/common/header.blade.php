...
<header id="header" class="site-header bg-white">
    <div class="4xl:px-[200px] 4xl:py-[20px] 3xl:py-[5px] py-[10px]" id="header-top">
        <div class="flex justify-between">
            <div class="flex items-center">
                <a href="{{ url('/') }}">
                    <img src="{{ asset($fcSystem['homepage_logo']) }}" class="2xl:h-[120px] h-[70px] w-auto" alt="">
                </a>
                <h3 class="4xl:ml-[120px] text-[#6a0f11] 4xl:text-f31 3xl:text-f19 xl:text-f14 2xl:block hidden">{!! $fcSystem['homepage_brandname'] !!}</b></h3>
            </div>
            <div class="flex items-center">
                @if( isset(Auth::guard('customer')->user()->id) )
                <a href="{{ route('customer.dashboard') }}" class="flex items-center">
                    <span class="bg-[#999999] 4xl:w-[55px] 4xl:h-[55px] xl:w-[35px] xl:h-[35px] w-[30px] h-[30px] rounded-full flex justify-center items-center">
                    ...
                    <span class="ml-2 2xl:text-f16 text-f14">{{ Auth::guard('customer')->user()->name }}</span>
                </a>
                @else
                <form action="" id="headerLogin">
                    ...
                    <div class="flex gap-[20px] 4xl:text-f20 3xl:text-f13 text-f14">
                        ...
                        <div>
                            <div class="flex">
                                <span class="bg-[#999999] 4xl:w-[55px] 4xl:h-[55px] xl:w-[35px] xl:h-[35px] lg:w-[40px] lg:h-[40px] round-[5px] h-[30px] w-[30px] flex justify-center items-center">
                                    <svg class="4xl:w-[35px] 4xl:h-[35px] xl:w-[28px] xl:h-[28px] h-[25px] w-[25px]" fill="#ffffff" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M127.99414,116a23.99788,23.99788,0,0,0-4,47.6604V184a4,4,0,1,0,8,0V163.6604a23.99788,23.99788,0,0,0-4-47.6604Zm0,40a16,16,0,1,1,16-16A16.01833,16.01833,0,0,1,127.99414,156Zm80-72h-40V52a40,40,0,1,0-80,0V84h-40a12.01375,12.01375,0,0,0-12,12V208a12.01375,12.01375,0,0,0,12,12h160a12.01375,12.01375,0,0,0,12-12V96A12.01375,12.01375,0,0,0,207.99414,84Zm-112-32a32,32,0,1,1,64,0V84h-64Zm116,156a4.00458,4.00458,0,0,1-4,4h-160a4.00458,4.00458,0,0,1-4-4V96a4.00458,4.00458,0,0,1,4-4h160a4.00458,4.00458,0,0,1,4,4Z"></path> </g></svg>
                                </span>
                                <input type="password" name="password" class="4xl:h-[55px] xl:h-[35px] 4xl:w-[225px] xl:w-[150px] lg:h-[40px] w-[150px] border round-[5px] border-[#e5e5e5] text-[#969696] outline-none px-2" placeholder="Mật khẩu">
                            </div>
                            <a href="" class="text-[#2f51ad] inline-block mt-4">Đổi mật khẩu</a>
                        </div>
                        <div>
                            <button type="submit" class="4xl:px-[100px] 4xl:h-[55px] xl:px-[25px] xl:h-[35px] lg:h-[40px] px-[15px] h-[30px] rounded-[5px] bg-[#999999] text-white flex justify-center items-center text-22 uppercase">Đăng nhập</button>
                        </div>
                    </div>
                </form>
                @endif
    ...
    <div class="bg-[#bf8d35] 4xl:py-[10px] 2xl:py-[5px] md:py-[8px]">
        <div class="container">
            <div class="">
                <div class="lg:hidden flex h-full justify-end items-center py-1">
                    <a href="javascript:void(0)" class="" id="menuBar">
                        <svg fill="#ffffff" class="w-9 h-9" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M3.5,7 C3.22385763,7 3,6.77614237 3,6.5 C3,6.22385763 3.22385763,6 3.5,6 L20.5,6 C20.7761424,6 21,6.22385763 21,6.5 C21,6.77614237 20.7761424,7 20.5,7 L3.5,7 Z M3.5,12 C3.22385763,12 3,11.7761424 3,11.5 C3,11.2238576 3.22385763,11 3.5,11 L20.5,11 C20.7761424,11 21,11.2238576 21,11.5 C21,11.7761424 20.7761424,12 20.5,12 L3.5,12 Z M3.5,17 C3.22385763,17 3,16.7761424 3,16.5 C3,16.2238576 3.22385763,16 3.5,16 L20.5,16 C20.7761424,16 21,16.2238576 21,16.5 C21,16.7761424 20.7761424,17 20.5,17 L3.5,17 Z"></path> </g></svg>
                    </a>
                </div>
                <ul class="lg:flex hidden text-white 4xl:text-f30 xl:text-f18 text-f18 justify-between items-center" id="listMenuBar">
                    <li class="">
                        <a href="{{ url('/') }}">
                            <img src="upload/images/logo/logo-menu.png" class="4xl:h-[60px] xl:h-[45px] h-[40px] w-auto" alt="">
                        </a>
                    </li>
                    @if( isset($menu_header) && $menu_header->menu_items->isNotEmpty() )
                    @foreach ($menu_header->menu_items as $item)
                        <li>
                    ...
                    @endif
                    <li>
                        <a href="javascript:void(0)"><img src="{{ asset('frontend/images/search.png') }}" class="4xl:h-auto 3xl:h-[25px] h-[20px]" alt=""></a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="notification-box flex flex-col items-center justify-center fixed w-full z-50 p-3 top-[5px]">
</div>
        ...
        $("#headerLogin").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                 ...
                 error: function(xhr) {
                    sendNotification('error', 'Có lỗi! Vui lòng thử lại')
                }
            });
        });

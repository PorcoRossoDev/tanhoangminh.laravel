            ...
            <div class="container ">
                <div class="flex items-center justify-between nav-container">
                    ...
                    <nav class="menu font-bold hc-nav-original hc-nav-1" id="main-nav">
                        <ul class="flex 3xl:text-f20 2xl:text-f18 whitespace-nowrap uppercase gap-10">
                    ...
                    <a href="{{ $customerLogin['url'] }}" class="ml-4 border-2 border-color_primary rounded-[42px] h-[54px] 2xl:px-[12px] px-[15px] w-[190px] flex items-center justify-center">

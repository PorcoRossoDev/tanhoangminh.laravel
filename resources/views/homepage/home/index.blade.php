    ...
    <div class="main-page">
                                                    ...
                                                    <div class="@if($k==0) 4xl:w-[528px] 3xl:w-[345px] 2xl:w-[400px] xl:w-1/2 md:w-1/2 w-full @else flex-1 @endif md:mb-0 mb-3">
                                                        <div class="relative rounded-[30px] overflow-hidden">
                                                            ...
                                                            <div class="bg-color_primary 3xl:px-[22px] 3lx:py-[20px] xl:px-[15px] xl:py-[15px] p-[15px] relative z-10 w-full">
                                                                <h4 class="4xl:text-f24 3xl:text-f19 text-f20 text-white font-semibold" style="
                                                                overflow: hidden;
            ...
            <div class="container">
                @if( isset($block2_info) )
                    @foreach ($block2_info->image as $k => $image )
                        <div class="wow fadeInUp">
                            <img src="{{ asset($image) }}" class="inline-block 4xl:h-[77px] 3xl:h-[55px] xl:h-[53px] sm:h-[45px] h-[35px] w-auto object-contain" alt="">
                            <h3 class="font-misslegate 4xl:pl-[180px] 4xl:text-[96px] 4xl:h-[86px] 4xl:leading-[40px] 3xl:h-[45px] 3xl:text-[55px] 3xl:leading-[35px] 3xl:pl-[130px] xl:h-[60px] xl:leading-[31px] xl:text-[76px] 3xl:mt-[28px] xl:mt-[20px] sm:h-[50px] sm:leading-[30px] sm:mt-[15px] sm:text-[68px] text-[50px] h-[38px] leading-[21px] mt-3">{{ $block2_info->title[$k] }}</h3>
                            <div class="4xl:pl-[180px] 3xl:text-f30   3xl:pl-[130px] xl:text-f22 3xl:mt-[21px] xl:mt-[15px] mt-[15px] sm:text-[19px] text-f14 text-color_primary">{{ $block2_info->desc[$k] }}</div>
                        </div>
                    @endforeach
                @endif
                ...
                @if( isset($block2_images) )
                    ...
                    <div class="mt-[50px] relative">
                        ...
                        <div class="swiper-prev-5 swiper-ctm absolute top-1/2 translate-y-[-50%] 4xl:left-0 xl:left-[-85px] z-10">
                            <img src="{{ asset('frontend/images/button-left.png') }}" class="4xl:w-auto 3xl:h-[35px]" alt="">
                        </div>
                        <div class="swiper-next-5 swiper-ctm absolute top-1/2 translate-y-[-50%] 4xl:right-0 xl:right-[-85px] z-10">
            ...
            @foreach ($isVanHoa as $cat)
                @if( isset($cat->posts) )
                    <section class="2xl:mt-[156px] xl:mt-[80px] mt-[55px]">
                        <div class="container">
                            <div class="flex 4xl:gap-[75px] 3xl:gap-[70px] xl:gap-[50px] gap-[12px]">
                                <div class="4xl:w-[1315px] 3xl:w-[70%] xl:w-[65%] xl:order-1 order-2">
                                    <div class="flex 4xl:gap-[20px] gap-[12px] md-hidden-5">
                                        @foreach($cat->posts as $k => $post)
                                            @if( $k == 0 || $k == 1 )
                                                <div class="@if( $k==0 ) 4xl:w-[975px] 3xl:w-[580px] xl:w-1/2 @else flex-1 @endif relative rounded-[30px] overflow-hidden wow fadeInUp" data-wow-delay="0.1s">
                                                    @include('homepage.home.item.item_block_3', ['post' => $post, 'k' => $k, 'height' => '4xl:h-[435px]', 'cat_slug' => $cat->slug, 'cat_title' => $cat->title])
                                                </div>
                                            @endif
                                        @endforeach
                                    </div>
                                    <div class="flex 4xl:gap-[20px] gap-[12px] xl:mt-[20px] md:mt-[60px] mt-[35px] md-hidden-5">
                                        @foreach($cat->posts as $k => $post)
                                            @if( $k > 1 )
                                                <div class="@if( $k==2 ) 4xl:w-[640px] 3xl:w-[400px] xl:w-1/3 @else flex-1 @endif relative rounded-[30px] overflow-hidden wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="flex-1 xl:order-2 order-1 wow fadeInRight" data-wow-duration="1s">
                                    <div class="flex h-full justify-center">
                                        <div class="text-left w-full">
                                            @if( !empty($cat->image) )
                                                <img src="{{ asset($cat->image) }}" class="4xl:h-[333px] 3xl:h-[215px] 2xl:h-[245px] xl:h-[150px] lg:h-[300px] h-[200px] inline-block object-contain object-bottom" alt="">
                                            @endif
                                            <div class="4xl:text-f30 3xl:text-f22 4xl:mt-[85px] 3xl:mt-[55px] sm:mt-[35px] lg:text-justify sm:text-f22 text-16 mt-[20px] ">
                                                {!! $cat->description !!}
                                            </div>
                                            <div class="xl:text-left text-center mt-[55px]">
                                                <a href="">
                                                    <img src="{{ asset('frontend/images/readmore.png') }}" alt="">
                                                </a>
        ...
        @if( isset($teamSlide) && $teamSlide->slides->isNotEmpty() )
            <section class="bg-[#f5f5f5] py-[60px]">
                <div class="container">
                    <h3 class="text-center 4xl:text-f40 3xl:text-f30 xl:text-f26">{{ $teamSlide->title }}</h3>
                    <div class="relative mt-[110px]">
                        <div class="swiper-block-team swiper-container wow fadeInUp">
                            <div class="swiper-wrapper">
                                @foreach ($teamSlide->slides as $slide)
                                    <div class="swiper-slide text-center">
                                        <div class="4xl:w-[250px] 4xl:h-[250px] 3xl:w-[200px] 3xl:h-[200px] xl:w-[170px] xl:h-[170px] inline-block relative">
                                            <img src="{{ asset($slide->src) }}" class="object-cover w-full h-full rounded-full inline-block" alt="">
                                            <span class="absolute top-0 right-0 border-[2px] border-white w-[60px] h-[60px] flex justify-center items-center rounded-full bg-[#369e74]">
            ...
            <section class="mt-[85px]">
                <div class="container tabBlock">
                    <div class="flex justify-center items-center lg:text-left text-center mb-[45px] wow fadeInUp">
                        <div>
                            <h3 class="font-misslegate 4xl:text-[116px] 4xl:h-[120px] 3xl:text-[100px] 3xl:h-[105px] xl:text-[80px] xl:h-[80px]">Điểm tin</h3>
                            <h3 class="font-bold 4xl:text-[72px] 3xl:text-[55px] 2xl:text-[56px] xl:text-[42px] sm:text-[54px] text-[36px] text-color_primary">{{ $homeBDS->first()->title }}</h3>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 4xl:gap-[35px] 3xl:gap-[25px] xl:gap-[20px]">
                        @foreach ($isVanHoa->first()->posts as $post)
                            <div class="flex items-center">
                                <div class="4xl:w-[418px] 3xl:w-[300px] xl:w-[250px] w-200px">
                                    <img src="{{ asset($post->image) }}" class="w-full 4xl:h-[265px] 3xl:h-[255px] xl:h-[210px] h-[250px] rounded-[20px] object-cover" alt="">
                                </div>
        ...
        @if( isset($homeMedia) && count($homeMedia->children) )
            <section class="mt-[110px] mb-[80px]">
                <div class="container">
                    <div class="xl:flex 4xl:gap-[170px] 3xl:gap-[100px] 2xl:gap-[85px] xl:gap-[50px] mt-[22px] tabBlock">
                        <div class="flex-1 lg:flex 2xl:justify-left justify-center items-center wow fadeInLeft">
                            <div>
                                <h3 class="4xl:text-[126px] 3xl:text-[100px] 3xl:leading-[92px] 2xl:text-[110px] xl:text-[65px] xl:leading-[60px] x xl:text-left text-center sm:text-[54px] text-[36px] font-bold uppercase 4xl:leading-[105px] 2xl:leading-[100px]">
                        ...
                        <div class="4xl:w-[1400px] 3xl:w-[850px] 2xl:w-[880px] xl:w-[700px] w-full wow fadeInRight">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="flex gap-[15px]">
                                                                @foreach ($item as $k => $media)
                                                                    @if( $k == 0 )
                                                                        <div class="4xl:w-[930px] 3xl:w-[600px] xl:w-[65%]">
                                                                            <div class="relative">
                                                                                <img src="{{ asset( $media['image']) }}" class="w-full 4xl:h-[590px] 3xl:h-[460px] xl:h-[360px] rounded-[20px]" alt="">
                                                                                <a href="{{ $media['video_iframe'] }}" data-fancybox="" class="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]">
                                                                                    <img src="/upload/images/logo/icon-play.png" alt="" class="4xl:w-auto 3xl:h-[50px]">
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    @endif
                                                                ...
                                                                <div class="flex-1 grid grid-cols-1 gap-[15px]">
                                                                    @foreach ($item as $k => $media)
                                                                        @if( $k > 0 )
                                                                            <div class="relative">
                                                                                <img src="{{ asset( $media['image']) }}" class="w-full 4xl:h-[285px] 3xl:h-[220px] xl:h-[170px] rounded-[20px]" alt="">
                                                                                <a href="{{ $media['video_iframe'] }}" data-fancybox="" class="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]">
                                                                                    <img src="/upload/images/logo/icon-play.png" alt="" class="4xl:w-auto 3xl:h-[50px]">
                                                                                </a>
                                                                            </div>

                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="slider__image">
                                    <a href="{{asset($detail->image)}}" data-fancybox="images">
                                        <img src="{{asset($detail->image)}}" alt="{{$detail->title}}" class="w-full h-[300px] md:h-[400px] lg:h-[300px] object-contain" />
                                    </a>
                                </div>
                            </div>
                            @if(!empty($listAlbums))
                            ...
                            <div class="swiper-slide">
                                <div class="slider__image">
                                    <a href="{{asset($item)}}" data-fancybox="images">
                                        <img src="{{asset($item)}}" alt="{{$detail->title}}" class="w-full h-[300px] md:h-[400px] lg:h-[300px] object-contain" />
                                    </a>    
                                </div>
                            </div>
                            @endforeach
    ...
    <div class="wow fadeInRight px-4">
        ...
        <p class="text-f14 hide hidden">
            ...
            {{trans('index.status')}}: <span class="text-blue_primary">
                ...
                ?>
                @else
                <span class="js_product_stock hide hidden">{{trans('index.InOfStock')}}</span>
                @endif
            </span>
        </p>
...
<script src="{{asset('frontend/library/js/trans.js')}}"></script>
